...
void MainWindow::Audio_Init(int sample_rate, int channel_count, int sample_size, QString codec, QAudioFormat::Endian byte_order, QAudioFormat::SampleType sample_type)
{
    /*
...
void MainWindow::Audio_Start_Listen(qreal volume, int cycles_cnt)
{
...
void MainWindow::Audio_Get_Info()
{
    //выводит информацю об устройстве по факту его работы
...
QVector<qreal> MainWindow::Create_Signal(QString func, qreal freq, qreal amplitude)
{
